...
@dso_cache = dso_local local_unnamed_addr global [312 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 566722661, ; hash 0x21c78065, from name: libaot-DiarioAndroid
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 798464603, ; hash 0x2f979a5b, from name: DiarioAndroid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DiarioAndroid.dll.so
		ptr null; void* handle (0x0)
	}, ; 44
	...
	%struct.DSOCacheEntry {
		i64 1885876438, ; hash 0x706830d6, from name: DiarioAndroid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DiarioAndroid.dll.so
		ptr null; void* handle (0x0)
	}, ; 129
	...
	%struct.DSOCacheEntry {
		i64 2190264538, ; hash 0x828cc8da, from name: libaot-DiarioAndroid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DiarioAndroid.dll.so
		ptr null; void* handle (0x0)
	}, ; 168
	...
	%struct.DSOCacheEntry {
		i64 2512588843, ; hash 0x95c3102b, from name: aot-DiarioAndroid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DiarioAndroid.dll.so
		ptr null; void* handle (0x0)
	}, ; 193
	...
	%struct.DSOCacheEntry {
		i64 3961373557, ; hash 0xec1dc375, from name: aot-DiarioAndroid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DiarioAndroid.dll.so
		ptr null; void* handle (0x0)
	}, ; 290
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [48 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
